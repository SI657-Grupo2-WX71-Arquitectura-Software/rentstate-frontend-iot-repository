...
export default async function linkDevice(userData, propertyId, deviceId, devicePassword) {
    const response = await myAxiosRequester.post(`user/${userData.id}/devices/link`, {
